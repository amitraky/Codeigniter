 <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">Sell Currency</h1>
            <span class="pagedesc">Welcome to Sell Currency</span>
            
            <ul class="hornav">
                <li class="current"><a href="#basicform">Sell</a></li>
            </ul>
        </div><!--pageheader-->
                ...
                <br>
                     ...
                     <p>
                        ...
                        <p class="stdformbutton">
                           ...
                           <input type="hidden" name="page" id="page" value="sell"   /> 
