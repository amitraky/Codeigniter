        ...
        <div id="contentwrapper" class="contentwrapper">
        	...
        	<div id="basicform" class="subcontent">
                  ...
                  <?php echo get_msg(); ?>
					...
					<form id="basiec" class="stdform stdform2" method="post" action="<?php echo base_url('admin/profile')?>">
                    	<p>
                        	<label>Name</label>
                        ...
                        <p>
                            ...
                            <span class="field">
                                  <select id="status" name="status" style="opacity: 0;">
                                   ...
                                   <option value="0" <?php if($row->or_m_status == 0)echo "selected";?>>Pending</option>
                                    <option value="1" <?php if($row->or_m_status == 1)echo "selected";?>>Active</option>
                                    <option value="2" <?php if($row->or_m_status == 2)echo "selected";?>>Inactive</option>
                                </select>
            ...
            <div id="validation" class="subcontent" style="display: none">
            	  <div class="contenttitle2">
                    ...
                    <form class="stdform stdform2" method="post" action="<?php echo base_url('admin/profile')?>" enctype="multipart/form-data">
                    	<p>
            ...
            <div id="address" class="subcontent" style="display: none">
            	  <div class="contenttitle2">
                    ...
                    <form class="stdform stdform2" method="post" action="<?php echo base_url('admin/profile')?>">
                    	<p>
                        	<label>Country</label>
                            <span class="field">
            ...
            <div id="ip_address" class="subcontent" style="display:none">
             ...
             <div id="password" class="subcontent" style="display:none">
            	  <div class="contenttitle2">
                     ...
                     <br clear="all" />
                    <form id="updatepwd" class="stdform stdform2" method="post" action="<?php echo base_url('admin/profile')?>">
