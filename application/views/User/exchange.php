 <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav">
                <li class="current"><a href="#step1">Exchange Currency INFORMATION</a></li>
            </ul>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="step1" class="subcontent">
                    ...
                    <br />
                      ...
                      <p>
                        ...
                        <p style="border-top:1px solid #ddd ">
                            ...
                            <span class="field">
							<select name="recive_currency" id="recive_currency">
                            	<option>Choose One</option>
                                 <?php  foreach($rows as $row){?>
                                  <option value="<?php echo $row->m6_id; ?>"><?php echo $row->m6_name; ?></option>
                            <?php } ?>
                    ...
                    <br />
                            ...
                            <span class="field"><b style="    color: green;    font-size: 15px;">sendmoneyto@gmail.com</b><br>
                      ...
                      <p>
                            ...
                            <span class="field"><input type="text" name="email"  id="email" class="smallinput" placeholder="Payza Email"/><br>
